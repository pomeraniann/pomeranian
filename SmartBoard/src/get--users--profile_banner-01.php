...
/**************************************************
	...
	[GET users/profile_banner]のお試しプログラム

	認証方式: アクセストークン

	配布: SYNCER
	公式ドキュメント: https://dev.twitter.com/rest/reference/get/users/profile_banner
	日本語解説ページ: https://syncer.jp/twitter-api-matome/get/users/profile_banner
...
**************************************************/
	...
	$request_url = 'https://api.twitter.com/1.1/users/profile_banner.json' ;		// エンドポイント
	$request_method = 'GET' ;

	// パラメータA (オプション)
	$params_a = array(
		'user_id' => '' ,		// ユーザーID (どちらか必須)
		'screen_name' => $screen_name ,		// スクリーンネーム (どちらか必須)
	) ;
...
//	}
	...
	// タイトル
	$html .= '<h1 style="text-align:center; border-bottom:1px solid #555; padding-bottom:12px; margin-bottom:48px; color:#D36015;">users/profile_banner</h1>' ;
	...
	// フッター
	$html .= '<small style="display:block; border-top:1px solid #555; padding-top:12px; margin-top:72px; text-align:center; font-weight:700;">プログラムの説明: <a href="https://syncer.jp/twitter-api-matome/get/users/profile_banner" target="_blank">SYNCER</a></small>' ;
